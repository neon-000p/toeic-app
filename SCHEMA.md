...
```json
{
  ...
  "background": [ { "heading": "📌 業界の構図", "body": "...", "bodyEn": "..." } ],
...
**`background[].bodyEn`**
背景解説の英語版。日本語ですでに理解している話題を英語で読み直せるようにするためのもので、多読の素材になる。難易度は Summary と同じに揃える。2026-09-12 以前に作った教材には無いため、アプリ側は欠けていても動くようにしてある。
